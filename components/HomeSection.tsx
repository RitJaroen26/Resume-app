                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className={`text-5xl lg:text-6xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} leading-tight`}>
                                Pawarit
                                <span className={`block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                                    Jaroenphatthanasiri
                                </span>
                            </h1>
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            className={`text-lg leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-lg`}
                        >
                        ...
                        >
                            <button
                                ...
                                className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:scale-105 flex items-center gap-2"
                            >
                                View My Work
                            ...
                            <button
                                ...
                                className={`group border-2 ${isDarkMode ? 'border-gray-600 text-gray-300 hover:bg-gray-800' : 'border-gray-300 text-gray-700 hover:bg-gray-50'} px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg flex items-center gap-2`}
                            >
                                <Download size={20} />
                                Download CV
                            </button>
                ...
                >
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className={`text-center p-6 rounded-xl ${isDarkMode ? 'bg-[#282828]' : 'bg-white/60'} backdrop-blur-sm ${isDarkMode ? "border-none" : "border"} ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}
                        >
