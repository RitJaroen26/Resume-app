                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
                    ...
                    >
                        ...
                        <motion.p
                            ...
                            className={`text-base sm:text-lg leading-relaxed text-center md:text-left w-70 sm:w-90 md:w-full ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-md mx-auto md:mx-0`}
                        >
                            {isThai
                        ...
                        <div className="hidden xl:flex relative mx-auto w-80 h-80 lg:w-96 lg:h-96">
                            ...
                            <div className={`relative w-full h-full ${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-full flex items-center justify-center overflow-hidden`}>
                                <div className="w-110 h-110 rounded-full flex items-center justify-center">
                                    <Image src="/images/profile_image_01.png" width={800} height={800} alt="" placeholder="empty" className="object-cover w-full h-full rounded-full" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
